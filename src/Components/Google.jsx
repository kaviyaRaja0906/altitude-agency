    ...
    return(
      <div className="ads">
         ...
         <div className="ad-content">
            <div className="container" data-aos="fade-up">
                <div className="ad-header">
                    <h1 className="ad-h text-center">White Label Google PPC Ads</h1>
                </div>
                ...
                <div className="offer" data-aos="zoom-in">
                    ...
                    $497/Month upto $5k Adspend - 1 Client <br></br>
                    $5k - $10k Adspend Additional $250
                    </p>
                    <br></br>
         ...
         <div className="ans">
            ...
            <h3>What is white label Google PPC Ads management?</h3>
            <p>
